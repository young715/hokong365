...
<div class="cont_zhishi">
    <div class="left_zhishi">
        ...
        <?php
            $dopage->GetPage("SELECT * FROM `#@__infolist` WHERE (classid=2) AND checkinfo=true  AND delstate !=true ORDER BY orderid DESC",10);
            $num_tj=0;
        ...
        ?>
        <div class="one_zhishi">
            <div class="title_article"><a href="<?php echo $gourl; ?>"><?php echo $row['title']; ?></a><span>发表于 <?php echo date('Y-m-d',$row['posttime']); ?></span></div>
            <div class="zy_article"><?php echo mb_substr($row['description'],0,130,'utf-8').' ......';?></div>
        </div>
        <?php
            }
        ?>
