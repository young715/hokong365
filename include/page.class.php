	...
	function GetList()
	{
		...
		else
		{
			...
			if($this->page > 1)
			{
				...
				{
					$pagetxt .= '<li><a href="'.$nowurl.'page=1" title="第一页">&lt;&lt;</a></li>';
			...
			if($this->totalpage < 10)
			{
				for($i=1; $i <= $this->totalpage; $i++)
				{
					if($this->page == $i)
					{
						$pagetxt .= '<li class="active"><a href="javascript:;">'.$i.'</a></li>';
					}
					else
					{
						//伪静态设置
			...
			else
			{
				...
				for($i=$m; $i<=$b; $i++)
				{
					if($this->page == $i)
					{
						$pagetxt .= '<li class="active"><a href="'.$nowurl.'page='.$i.'">'.$i.'</a></li>';
					}
					else
					{
						//伪静态设置
			...
			if($this->page < $this->totalpage)
			{
				   ...
				   !isset($keyword))
				{
					...
					$pagetxt .= '<li><a href="'.$nowurl.'-'.$this->totalpage.'.html" title="最后一页">&gt;&gt;</a></li>';
				}
				else
				{
			...
			{
				$pagetxt .= '<li><a href="javascript:;" title="已是最后一页">&gt;</a></li>';
				$pagetxt .= '<li><a href="javascript:;" title="已是最后一页">&gt;&gt;</a></li>';
			}
			$pagetxt .= '</ul>';
		}
